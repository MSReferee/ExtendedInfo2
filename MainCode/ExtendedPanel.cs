...
namespace IINS.ExtendedInfo
{
    public class ExtendedPanel : MUIPanel
    {
        ...
        public static Color COLOR_DARK_TEXT = MUIUtil.DarkenColor(COLOR_TEXT, 0.3f, 1.0f);
        public static Color COLOR_CAPTION = MUIUtil.DarkenColor(COLOR_TEXT, 0.5f, 1.0f); // MUIUtil.BrightenColor(Color.grey, 0.35f);
        public static Color COLOR_PURPLE = new Color32(170, 58, 183, 255);
        public static Color COLOR_DARK_PURPLE = MUIUtil.DarkenColor(COLOR_PURPLE, 0.35f, 1.0f);
        public static Color COLOR_DARK_RED = MUIUtil.DarkenColor(Color.red, 0.54f, 1.0f);
        public static Color COLOR_DARK_GREEN = MUIUtil.DarkenColor(Color.green, 0.54f, 1.0f);
        public static Color COLOR_DARK_YELLOW = MUIUtil.DarkenColor(Color.yellow, 0.45f, 1.0f);
        ...
        {
            isVisible = false;
            color = MUIUtil.DarkenColor(Color.grey, 0.3f, 1.0f);
        }
        ...
        public override void Awake()
        {
            ...
            lineTexture.SetPixel(1, 1, MUIUtil.DarkenColor(Color.grey, 0.10f, 1.0f));
            lineTexture.Apply();
        }
